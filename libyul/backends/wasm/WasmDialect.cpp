...
void WasmDialect::addExternals()
{
	...
	static vector<External> externals{
		{"gdtu", "getAddress", {i32ptr}, {}},
		{"gdtu", "getExternalBalance", {i32ptr, i32ptr}, {}},
		{"gdtu", "getBlockHash", {i64, i32ptr}, {i32}},
		{"gdtu", "call", {i64, i32ptr, i32ptr, i32ptr, i32}, {i32}},
		{"gdtu", "callDataCopy", {i32ptr, i32, i32}, {}},
		{"gdtu", "getCallDataSize", {}, {i32}},
		{"gdtu", "callCode", {i64, i32ptr, i32ptr, i32ptr, i32}, {i32}},
		{"gdtu", "callDelegate", {i64, i32ptr, i32ptr, i32}, {i32}},
		{"gdtu", "callStatic", {i64, i32ptr, i32ptr, i32}, {i32}},
		{"gdtu", "storageStore", {i32ptr, i32ptr}, {}},
		{"gdtu", "storageLoad", {i32ptr, i32ptr}, {}},
		{"gdtu", "getCaller", {i32ptr}, {}},
		{"gdtu", "getCallValue", {i32ptr}, {}},
		{"gdtu", "codeCopy", {i32ptr, i32, i32}, {}},
		{"gdtu", "getCodeSize", {}, {i32}},
		{"gdtu", "getBlockCoinbase", {i32ptr}, {}},
		{"gdtu", "create", {i32ptr, i32ptr, i32, i32ptr}, {i32}},
		{"gdtu", "getBlockDifficulty", {i32ptr}, {}},
		{"gdtu", "externalCodeCopy", {i32ptr, i32ptr, i32, i32}, {}},
		{"gdtu", "getExternalCodeSize", {i32ptr}, {i32}},
		{"gdtu", "getGasLeft", {}, {i64}},
		{"gdtu", "getBlockGasLimit", {}, {i64}},
		{"gdtu", "getTxGasPrice", {i32ptr}, {}},
		{"gdtu", "log", {i32ptr, i32, i32, i32ptr, i32ptr, i32ptr, i32ptr}, {}},
		{"gdtu", "getBlockNumber", {}, {i64}},
		{"gdtu", "getTxOrigin", {i32ptr}, {}},
		{"gdtu", "finish", {i32ptr, i32}, {}, ControlFlowSideEffects{true, false}},
		{"gdtu", "revert", {i32ptr, i32}, {}, ControlFlowSideEffects{true, true}},
		{"gdtu", "getReturnDataSize", {}, {i32}},
		{"gdtu", "returnDataCopy", {i32ptr, i32, i32}, {}},
		{"gdtu", "selfDestruct", {i32ptr}, {}, ControlFlowSideEffects{true, false}},
		{"gdtu", "getBlockTimestamp", {}, {i64}},
		{"debug", "print32", {i32}, {}},
		{"debug", "print64", {i64}, {}},
