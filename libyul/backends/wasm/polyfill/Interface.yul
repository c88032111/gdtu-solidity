...
function origin() -> z1, z2, z3, z4 {
	gdtu.getTxOrigin(12:i32)
	z1, z2, z3, z4 := mload_address(0:i32)
}

function caller() -> z1, z2, z3, z4 {
	gdtu.getCaller(12:i32)
	z1, z2, z3, z4 := mload_address(0:i32)
}

function callvalue() -> z1, z2, z3, z4 {
	gdtu.getCallValue(0:i32)
	z3 := i64.load(8:i32)
	z4 := i64.load(0:i32)
}
...
function calldatasize() -> z1, z2, z3, z4 {
	z4 := i64.extend_i32_u(gdtu.getCallDataSize())
}

function calldatacopy(x1, x2, x3, x4, y1, y2, y3, y4, z1, z2, z3, z4) {
	let cds:i32 := gdtu.getCallDataSize()
...
function codesize() -> z1, z2, z3, z4 {
	z4 := i64.extend_i32_u(gdtu.getCodeSize())
}
...
function extcodesize_internal(x1, x2, x3, x4) -> r:i32 {
	mstore_address(0:i32, x1, x2, x3, x4)
	r := gdtu.getExternalCodeSize(12:i32)
}
...
function extcodecopy(a1, a2, a3, a4, p1, p2, p3, p4, o1, o2, o3, o4, l1, l2, l3, l4) {
	...
	gdtu.externalCodeCopy(12:i32, to_internal_i32ptr(p1, p2, p3, p4), codeOffset, codeLength)
}

function returndatasize() -> z1, z2, z3, z4 {
	z4 := i64.extend_i32_u(gdtu.getReturnDataSize())
}
...
function blockhash(x1, x2, x3, x4) -> z1, z2, z3, z4 {
	let r:i32 := gdtu.getBlockHash(u256_to_i64(x1, x2, x3, x4), 0:i32)
	if i32.eqz(r) {
		z1, z2, z3, z4 := mload_internal(0:i32)
	}
}
...
function coinbase() -> z1, z2, z3, z4 {
	gdtu.getBlockCoinbase(12:i32)
	z1, z2, z3, z4 := mload_address(0:i32)
}

function timestamp() -> z1, z2, z3, z4 {
	z4 := gdtu.getBlockTimestamp()
}

function number() -> z1, z2, z3, z4 {
	z4 := gdtu.getBlockNumber()
}

function difficulty() -> z1, z2, z3, z4 {
	gdtu.getBlockDifficulty(0:i32)
	z1 := i64.load(24:i32)
	z2 := i64.load(16:i32)
	z3 := i64.load(8:i32)
	z4 := i64.load(0:i32)
...
function sstore(x1, x2, x3, x4, y1, y2, y3, y4) {
	...
	gdtu.storageStore(0:i32, 32:i32)
}
...
function create(
	...
	let r:i32 := gdtu.create(0:i32, to_internal_i32ptr(y1, y2, y3, y4), u256_to_i32(z1, z2, z3, z4), 32:i32)
	if i32.eqz(r) {
...
function call(
	...
	x4 := i64.extend_i32_u(gdtu.call(g, 12:i32, 32:i32, to_internal_i32ptr(d1, d2, d3, d4), u256_to_i32(e1, e2, e3, e4)))
}
...
function callcode(
	...
	x4 := i64.extend_i32_u(gdtu.callCode(
...
function delegatecall(
	...
	x4 := i64.extend_i32_u(gdtu.callDelegate(
		u256_to_i64(a1, a2, a3, a4),
		12:i32,
...
function staticcall(
	...
	x4 := i64.extend_i32_u(gdtu.callStatic(
		u256_to_i64(a1, a2, a3, a4),
		12:i32,
		to_internal_i32ptr(c1, c2, c3, c4),
		u256_to_i32(d1, d2, d3, d4)
