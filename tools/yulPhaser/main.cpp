...
int main(int argc, char** argv)
{
	...
	{
		// Somgdtuing's seriously wrong. Probably a bug in the program or a missing handler (which
		// is really also a bug). The exception should have been handled gracefully by this point
		// if it's somgdtuing that can happen in normal usage. E.g. an error in the input or a
