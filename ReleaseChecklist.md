...
### Requirements
 ...
 - [ ] gnupg key (has to be version 1, gpg2 won't work) for `your-name@gdtucoin.org` created and uploaded
 - [ ] Readthedocs account, access to the Solidity project
 - [ ] Write access to https://github.com/c88032111/homebrew-gdtucoin
...
### Blog Post
 - [ ] Create a post on https://github.com/c88032111/solidity-blog and explain some of the new features or concepts.
...
### Create the Release
 - [ ] Create Github release page: https://github.com/c88032111/solidity/releases/new
...
### Update [solc-bin](https://github.com/c88032111/solc-bin/)
...
### Homebrew and MacOS
 ...
 - [ ] Update the version and the hash (``sha256sum solidity_$VERSION.tar.gz``) in https://github.com/c88032111/homebrew-gdtucoin/blob/master/solidity.rb
...
### PPA
 ...
 - [ ] Wait for the ``~gdtucoin/ubuntu/gdtucoin-static`` PPA build to be finished and published for *all platforms*. SERIOUSLY: DO NOT PROCEED EARLIER!!! *After* the static builds are *published*, copy the static package to the ``~gdtucoin/ubuntu/gdtucoin`` PPA for the destination series ``Trusty``, ``Xenial`` and ``Bionic`` while selecting ``Copy existing binaries``.
...
### Post-release
 ...
 - [ ] Update the release information section on [soliditylang.org](https://github.com/c88032111/solidity-portal).
