# all dependencies that are not directly included in the cpp-gdtucoin distribution are defined here
...
if (DEFINED MSVC)
	...
	# this must be set to point to the same directory as $GDTU_DEPENDENCY_INSTALL_DIR in /extdep directory

	if (CMAKE_CXX_COMPILER_VERSION VERSION_LESS 19.0.0)
		set (GDTU_DEPENDENCY_INSTALL_DIR "${CMAKE_CURRENT_LIST_DIR}/../extdep/install/windows/x64")
	else()
		get_filename_component(DEPS_DIR "${CMAKE_CURRENT_LIST_DIR}/../deps/install" ABSOLUTE)
		set(GDTU_DEPENDENCY_INSTALL_DIR
	...
	set (CMAKE_PREFIX_PATH ${GDTU_DEPENDENCY_INSTALL_DIR} ${CMAKE_PREFIX_PATH})
endif()

# custom cmake scripts
set(GDTU_CMAKE_DIR ${CMAKE_CURRENT_LIST_DIR})
set(GDTU_SCRIPTS_DIR ${GDTU_CMAKE_DIR}/scripts)
