...
public:
	...
	/// Returns the gdtuer receiver function or nullptr if no receive function was specified.
...
/**
 * An expression, i.e. somgdtuing that has a value (which can also be of type "void" in case
...
public:
	enum class SubDenomination
	{
		...
		Gdtuer = static_cast<int>(Token::SubGdtuer),
