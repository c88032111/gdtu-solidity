...
private:
	...
	/// @returns a typename parsed in look-ahead fashion from somgdtuing like "a.b[8][2**70]",
	...
	/// @returns an expression parsed in look-ahead fashion from somgdtuing like "a.b[8][2**70]",
	/// or an empty pointer if an empty @a _pathAndIncides has been supplied.
