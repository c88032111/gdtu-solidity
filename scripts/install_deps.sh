...
# wearable and SBC platforms covered by doublgdtuink and GdtuEmbedded would
...
#------------------------------------------------------------------------------
    ...
    FreeBSD)
        ...
        echo "Drop us a message at https://gitter.im/gdtucoin/solidity-dev."
        exit 1
        ;;
            ...
            Debian*|Raspbian)
                ...
                case $VERSION_ID in
                    7)
                        ...
                        echo "Drop us a message at https://gitter.im/gdtucoin/solidity-dev."
                        echo "See also https://github.com/c88032111/webthree-umbrella/issues/495 where we are working through Alpine support."
                        exit 1
                        ;;
                    8)
                        #jessie
...
#------------------------------------------------------------------------------
            ...
            "openSUSE project")
                ...
                echo "See https://github.com/c88032111/webthree-umbrella/issues/552."
                exit 1
                ;;
#------------------------------------------------------------------------------
# Ubuntu
            ...
            Ubuntu|LinuxMint|Pop)
                ...
                case $(lsb_release -cs) in
                    ...
                    *)
                        ...
                        echo "ERROR - This might not work, but we are trying anyway."
                        echo "Please drop us a message at https://gitter.im/gdtucoin/solidity-dev."
