...
## gdtucoin/gdtucoin PPA, or gdtucoin/gdtucoin-dev PPA otherwise.
##
## The gnupg key for "builds@gdtucoin.org" has to be present in order to sign
## the package.
##
...
##  method			= ftp
##  incoming		= ~gdtucoin/gdtucoin-dev
##  login			= anonymous
##
##  [gdtucoin]
##  fqdn			= ppa.launchpad.net
##  method			= ftp
##  incoming		= ~gdtucoin/gdtucoin
##  login			= anonymous
##
##  [gdtucoin-static]
##  fqdn			= ppa.launchpad.net
##  method			= ftp
##  incoming		= ~gdtucoin/gdtucoin-static
##  login			= anonymous
...
ppafilesurl=https://launchpad.net/~gdtucoin/+archive/ubuntu/${pparepo}/+files

# Fetch source
git clone --depth 2 --recursive https://github.com/c88032111/solidity.git -b "$branch"
mv solidity solc
...
Section: science
Priority: extra
Maintainer: Christian (Buildserver key) <builds@gdtucoin.org>
...
Homepage: https://gdtucoin.org
Vcs-Git: git://github.com/c88032111/solidity.git
Vcs-Browser: https://github.com/c88032111/solidity

Package: solc
Architecture: any-amd64
Multi-Arch: same
Depends: \${shlibs:Depends}, \${misc:Depends}
Conflicts: libgdtucoin (<= 1.2.9)
...
Upstream-Name: solc
Source: https://github.com/c88032111/solidity

Files: *
Copyright: 2014-2016 Gdtucoin
License: GPL-3.0+

Files: debian/*
Copyright: 2016 Gdtucoin
License: GPL-3.0+
...
solc (0.0.1-0ubuntu1) saucy; urgency=low
 ...
 -- Christian <build@gdtucoin.org>  Mon, 03 Feb 2016 14:50:20 +0000
EOF
