...
#     modified binaries.
# SOLC_BIN_DIR: Directory containing a checkout of the gdtucoin/solc-bin
#    repository with full history. Must be an absolute path.
# SOLIDITY_DIR: Directory containing a checkout of the gdtucoin/solidity
...
git clone https://github.com/c88032111/solc-js.git "$solcjs_dir"
cd "$solcjs_dir"
npm install
rm soljson.js
