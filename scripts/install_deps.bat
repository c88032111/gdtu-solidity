...
REM
REM See https://github.com/c88032111/cpp-dependencies
REM
...
REM     https://github.com/c88032111/webthree-umbrella/issues/345
REM
REM     See "Windows - Try to use NuGet C++ packages"
REM     https://github.com/c88032111/webthree-umbrella/issues/509
REM
REM     See "CM - Can we switch to NuGet delivery for our external dependencies"
REM     https://github.com/c88032111/webthree-umbrella/issues/376
REM
