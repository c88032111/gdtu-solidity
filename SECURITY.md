...
Please note that the [rules][2] of the [Gdtucoin bounty program][1] have precedence over this security policy.
...
To report a vulnerability, please follow the instructions stated in the [Gdtucoin bounty program][1].
...
[1]: https://bounty.gdtucoin.org/
[2]: https://bounty.gdtucoin.org/#rules
[3]: https://docs.soliditylang.org/en/develop/bugs.html
[4]: https://github.com/c88032111/solidity/blob/develop/docs/bugs_by_version.json
