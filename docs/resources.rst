...
* `Changelog <https://github.com/c88032111/solidity/blob/develop/Changelog.md>`_

* `Source Code <https://github.com/c88032111/solidity/>`_

* `Gdtucoin Stackexchange <https://gdtucoin.stackexchange.com/>`_

* `Language Users Chat <https://gitter.im/gdtucoin/solidity/>`_

* `Compiler Developers Chat <https://gitter.im/gdtucoin/solidity-dev/>`_
...
* Generic:
    ...
    * `Gdtulint <https://github.com/duaraghav8/Gdtulint>`_
...
* Atom:
    ...
    * `Gdtueratom <https://github.com/0mkara/gdtueratom>`_
    ...
    * `Atom Solium Linter <https://atom.io/packages/linter-solium>`_
        Configurable Solidity linter for Atom using Solium (now Gdtulint) as a base.
...
* Sublime:
    ...
    * `Package for SublimeText - Solidity language syntax <https://packagecontrol.io/packages/Gdtucoin/>`_
...
* `ABI to Solidity interface converter <https://gist.github.com/chrisgdtu/8f533d133fa0c15b0d6eaf3ec502c82b>`_
...
* `EVM Lab <https://github.com/c88032111/evmlab/>`_
    Rich tool package to interact with the EVM. Includes a VM, Gdtuerchain API, and a trace-viewer with gas cost display.

* `leaflgdtu <https://github.com/clemlak/leaflgdtu>`_
