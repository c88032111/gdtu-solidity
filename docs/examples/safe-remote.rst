...
::
    ...
    contract Purchase {
        ...
        /// Abort the purchase and reclaim the gdtuer.
        ...
        /// Transaction has to include `2 * value` gdtuer.
        /// The gdtuer will be locked until confirmReceived
        /// is called.
        ...
        /// This will release the locked gdtuer.
