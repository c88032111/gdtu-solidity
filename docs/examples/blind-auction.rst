...
auction contract on Gdtucoin.  We will start with an open auction where
...
/ Gdtuer in order to bind the bidders to their bid. If the highest bid is
...
::
    ...
    contract SimpleAuction {
        ...
        function auctionEnd() public {
            ...
            // with other contracts (i.e. they call functions or send Gdtuer)
            // into three phases:
            ...
            // effects (gdtuer payout) to be performed multiple times.
...
transfers cannot be blinded in Gdtucoin, anyone can see the value.
...
::
    ...
    contract BlindAuction {
        ...
        /// The sent gdtuer is only refunded if the bid is correctly
        /// revealed in the revealing phase. The bid is valid if the
        /// gdtuer sent together with the bid is at least "value" and
