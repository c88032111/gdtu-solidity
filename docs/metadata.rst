...
For additional information, read :doc:`Gdtucoin Natural Language Specification (NatSpec) format <natspec-format>`.
...
In the repository `sourcify <https://github.com/c88032111/sourcify>`_
