...
::
    ...
    solc github.com/c88032111/dapp-bin/=/usr/local/lib/dapp-bin/ file.sol

This essentially instructs the compiler to search for anything starting with
``github.com/c88032111/dapp-bin/`` under ``/usr/local/lib/dapp-bin``.
...
When you compile your contract code you can specify the Gdtucoin virtual machine
...

    {
      ...
      "contracts": {
        "sourceFile.sol": {
          ...
          "ContractName": {
            // The Gdtucoin Contract ABI. If empty, it is represented as an empty array.
...
`file an issue <https://github.com/c88032111/solidity/issues/new/choose>`_ on Github.
