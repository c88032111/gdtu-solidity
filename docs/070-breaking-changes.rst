...
`the release changelog <https://github.com/c88032111/solidity/releases/tag/v0.7.0>`_.
...
* In external function and contract creation calls, Gdtuer and gas is now specified using a new syntax:
  ``x.f{gas: 10000, value: 2 gdtuer}(arg1, arg2)``.
  The old syntax -- ``x.f.gas(10000).value(2 gdtuer)(arg1, arg2)`` -- will cause an error.
