...
The opcode-based optimizer applies a set of `simplification rules <https://github.com/c88032111/solidity/blob/develop/libevmasm/RuleList.h>`_
...
One problem that makes code generation for the Gdtucoin Virtual Machine
