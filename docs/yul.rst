...
is ``u256``, the 256-bit native type of the Gdtucoin Virtual Machine.
...
This document does not want to be a full description of the Gdtucoin virtual machine.
...
.. code-block:: yul
    ...
    object "Token" {
        ...
        object "runtime" {
            code {
                // Protection against sending Gdtuer
